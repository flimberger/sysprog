...
Eine schematische Darstellung findet sich in \hyperref[fig:stmtsnode]{Abbildung~\ref{fig:if}}.
...
Eine schematische Darstellung findet sich in \hyperref[fig:stmtsnode]{Abbildung~\ref{fig:while}}.
